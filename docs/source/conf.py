...
project = 'uchuutools'
copyright = '2019-2020, Manodeep Sinha'
...
modindex_common_prefix = ['uchuutools.']
...
html_baseurl = 'https://uchuutools.readthedocs.io/en/latest'


# -- Options for HTMLHelp output ---------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = 'uchuutools_doc'
...
latex_documents = [
    (master_doc, 'uchuutools.tex', html_title,
     author, 'manual'),
]
